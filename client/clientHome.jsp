...
<head>
  ...
  <body>
    ...
    <h2><span id="blueText">A Servlet/JSP-based Multi-tiered Enterprise Application Using A Tomcat Container</span></h2>

    <!-- White line break -->
    <hr>

    <!-- Connection text-->
    <p>You are connected to the Project 4 Enterprise System database as a <span class="perm">client-level</span> user.</p>
